...
namespace GroupDocs.Redaction.Live.Demos.UI
{
	public partial class WebForm1 : BasePage
	{
		...
		{
            GroupDocs.Redaction.Live.Demos.UI.Config.Configuration.GroupDocsAppsAPIBasePath = Request.Url.Scheme + "://" + Request.Url.Authority + Request.ApplicationPath.TrimEnd('/') + "/";
